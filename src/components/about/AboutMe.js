...
const AboutMe = () => {
  return (
    <div className="flex flex-col md:flex-row pb-6">
      <div className="w-full md:w-1/2 text-zinc-400 px-6 border-r-[1px] border-r-zinc-800 flex hover:text-white duration-200">
        <div className="py-6">
      ...
      <div className="w-full md:w-1/2 p-6">
        <ul className="flex flex-col gap-1 text-zinc-400 px-6 border-r-[1px] border-r-zinc-800 hover:text-white duration-200">
